<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevaLinea.aspx.cs" Inherits="GUI.Datos.NuevaLinea" MasterPageFile="~/Site.Master" %>
    ...
    <div class="container">
        <div class="form-row">
            <div class="form-group col-md-6">
                <asp:Label ID="lblNroLinea" runat="server" Text="Número de línea"></asp:Label>
                <asp:TextBox ID="txtNroLinea" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="form-group col-md-6">
                <asp:Label ID="lblTipoServicio" runat="server" Text="Tipo Servicio"></asp:Label>
                <asp:DropDownList ID="ddlTipoServicio" CssClass="form-control" runat="server"></asp:DropDownList>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
