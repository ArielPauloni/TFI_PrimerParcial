<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pto6.aspx.cs" Inherits="GUI.Consultas.Pto6"  MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="text-align: center;">
        <br />
        <br />
        <asp:Label ID="lblPto6" runat="server" Text="Obtener la recaudación de un mes discriminado por promoción" Font-Bold="true"></asp:Label>
        <br />
        <br />
    </div>
    <div class="container">
